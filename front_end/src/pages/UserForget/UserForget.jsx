...
const UserForget = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await instance.post("/user/forgetpassword", values);
            navigate("/user_login");
            setError(false);
            setSuccess(true);
        } catch (err) {
    ...
    return (
        <div className="formContainer3">
            <div className="formWrapper2">
                ...
                <span className="title">User Forget Password</span>
                        ...
                        return (
                            <>
                                <FormInput
                                    ...
                                    onChange={handleChange}
                                />
                                <button className="home3" id="shadowbtn" onClick={onSend}>Send validation code</button>
                            </>
                        )
                    })}

                    <button className="userForger" type='submit' id="shadowbtn">Reset Password</button>
                </form>
                <p>You don't have an account? <Link to="/user_register">Sign Up</Link></p>
                <Link to="/">
